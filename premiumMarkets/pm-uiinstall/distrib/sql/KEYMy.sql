...
ALTER TABLE TUNEDCONF CHARACTER SET utf8;
ALTER TABLE TUNEDCONF MODIFY SYMBOL VARCHAR(20) CHARACTER SET utf8;
ALTER TABLE TUNEDCONF MODIFY ISIN VARCHAR(20) CHARACTER SET utf8;
ALTER TABLE TUNEDCONF MODIFY EVENTDEFINITION VARCHAR(100) CHARACTER SET utf8;
ALTER TABLE  TUNEDCONF  ADD CONSTRAINT `FK_TUNEDCONF_TO_SHARES` FOREIGN KEY (`SYMBOL`, `ISIN`) REFERENCES `SHARES` (`SYMBOL`, `ISIN`) ON DELETE NO ACTION ON UPDATE NO ACTION;
