...
CREATE TABLE "APP"."PORTFOLIO" ("SYMBOL" VARCHAR(20) NOT NULL, "ISIN" VARCHAR(20) NOT NULL, "QUANTITY" NUMERIC(19,5), "CASHIN" DECIMAL(20,4), "CASHOUT" DECIMAL(20,4), "NAME" VARCHAR(255) NOT NULL, "MONITOR" SMALLINT NOT NULL DEFAULT 0, "BUYDATE" DATE DEFAULT '01/01/1970', "AVGBUYPRICE" DECIMAL(20,4) DEFAULT 0, "TRANSACTIONCURRENCY" CHAR(3) NOT NULL DEFAULT 'EUR', "ACCOUNT" VARCHAR(255));
