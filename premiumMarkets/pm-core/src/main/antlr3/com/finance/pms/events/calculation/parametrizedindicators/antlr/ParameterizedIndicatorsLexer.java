// $ANTLR 3.5.2 com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g 2018-09-12 22:58:01
 //lexer
...
public class ParameterizedIndicatorsLexer extends Lexer {
	...
	public final void mT__91() throws RecognitionException {
		try {
			int _type = T__91;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:97:7: ( 'trends like' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:97:9: 'trends like'
			{
			match("trends like"); 
	...
	public final void mT__92() throws RecognitionException {
		try {
			int _type = T__92;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:98:7: ( 'trends unlike' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:98:9: 'trends unlike'
			{
			match("trends unlike"); 
	...
	public final void mOperation() throws RecognitionException {
		try {
			int _type = Operation;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:304:7: ({...}? => ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:304:9: {...}? => ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
			{
			if ( !((runtimeOpAhead())) ) {
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:304:60: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
			int cnt1=0;
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mNumberToken() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:7: ( ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:9: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:9: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:11: ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:11: ( '-' )?
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:12: '-'
					{
					match('-'); 
					}
					break;
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:18: ( '0' .. '9' )+
			int cnt3=0;
			loop3:
			while (true) {
				int alt3=2;
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:30: ( '.' ( '0' .. '9' )+ )?
			int alt5=2;
			...
			switch (alt5) {
				case 1 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:31: '.' ( '0' .. '9' )+
					{
					match('.'); 
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:308:35: ( '0' .. '9' )+
					int cnt4=0;
					loop4:
					while (true) {
						int alt4=2;
	...
	public final void mStringToken() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:312:6: ( '\"' ( 'a' .. 'z' | 'A' .. 'Z' | '.' | '_' )* '\"' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:312:8: '\"' ( 'a' .. 'z' | 'A' .. 'Z' | '.' | '_' )* '\"'
			{
			match('\"'); 
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:312:12: ( 'a' .. 'z' | 'A' .. 'Z' | '.' | '_' )*
			loop6:
			while (true) {
				int alt6=2;
	...
	public final void mHistoricalData() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:4: ({...}? => ( 'open' | 'close' | 'high' | 'low' | 'volume' ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:6: {...}? => ( 'open' | 'close' | 'high' | 'low' | 'volume' )
			{
			if ( !((runtimeHistoryOpAhead())) ) {
				throw new FailedPredicateException(input, "HistoricalData", "runtimeHistoryOpAhead()");
			}
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:36: ( 'open' | 'close' | 'high' | 'low' | 'volume' )
			int alt7=5;
			switch ( input.LA(1) ) {
			case 'o':
				{
			...
			switch (alt7) {
				case 1 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:38: 'open'
					{
					match("open"); 
					...
					break;
				case 2 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:47: 'close'
					{
					match("close"); 
					...
					break;
				case 3 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:57: 'high'
					{
					match("high"); 
					...
					break;
				case 4 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:66: 'low'
					{
					match("low"); 
					...
					break;
				case 5 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:316:75: 'volume'
					{
					match("volume"); 
	...
	public final void mWhiteChar() throws RecognitionException {
		try {
			int _type = WhiteChar;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:320:7: ( ( ( ' ' )+ ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:320:9: ( ( ' ' )+ )
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:320:9: ( ( ' ' )+ )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:320:10: ( ' ' )+
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:320:10: ( ' ' )+
			int cnt8=0;
			loop8:
	...
	public final void mTcheat() throws RecognitionException {
		try {
			int _type = Tcheat;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:324:6: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+ )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:324:8: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:324:8: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
			int cnt9=0;
			loop9:
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:329:5: ( ( '\\r' | '\\t' | '\\u000C' | '\\n' ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:329:7: ( '\\r' | '\\t' | '\\u000C' | '\\n' )
			{
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:332:5: ( '/*' ( . )* '*/' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:332:7: '/*' ( . )* '*/'
			{
			match("/*"); 

			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:332:12: ( . )*
			loop10:
			while (true) {
				int alt10=2;
	...
	public final void mLINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:335:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:335:7: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
			{
			match("//"); 

			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:335:12: (~ ( '\\n' | '\\r' ) )*
			loop11:
			while (true) {
				int alt11=2;
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:335:26: ( '\\r' )?
			int alt12=2;
	...
	public void mTokens() throws RecognitionException {
		// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:8: ( AND | CLOSEPARENTEHSIS | COMMA | DAYS | LENIENT | NOT | OPENPARENTEHSIS | OR | PERCENT | T__52 | T__53 | T__54 | T__55 | T__56 | T__57 | T__58 | T__59 | T__60 | T__61 | T__62 | T__63 | T__64 | T__65 | T__66 | T__67 | T__68 | T__69 | T__70 | T__71 | T__72 | T__73 | T__74 | T__75 | T__76 | T__77 | T__78 | T__79 | T__80 | T__81 | T__82 | T__83 | T__84 | T__85 | T__86 | T__87 | T__88 | T__89 | T__90 | T__91 | T__92 | Operation | NumberToken | StringToken | HistoricalData | WhiteChar | Tcheat | WS | COMMENT | LINE_COMMENT )
		int alt13=59;
		...
		switch (alt13) {
			...
			case 9 :
				...
				break;
			case 10 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:81: T__52
				{
				mT__52(); 
				...
				break;
			case 11 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:87: T__53
				{
				mT__53(); 
				...
				break;
			case 12 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:93: T__54
				{
				mT__54(); 
				...
				break;
			case 13 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:99: T__55
				{
				mT__55(); 
				...
				break;
			case 14 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:105: T__56
				{
				mT__56(); 
				...
				break;
			case 15 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:111: T__57
				{
				mT__57(); 
				...
				break;
			case 16 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:117: T__58
				{
				mT__58(); 
				...
				break;
			case 17 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:123: T__59
				{
				mT__59(); 
				...
				break;
			case 18 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:129: T__60
				{
				mT__60(); 
				...
				break;
			case 19 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:135: T__61
				{
				mT__61(); 
				...
				break;
			case 20 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:141: T__62
				{
				mT__62(); 
				...
				break;
			case 21 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:147: T__63
				{
				mT__63(); 
				...
				break;
			case 22 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:153: T__64
				{
				mT__64(); 
				...
				break;
			case 23 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:159: T__65
				{
				mT__65(); 
				...
				break;
			case 24 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:165: T__66
				{
				mT__66(); 
				...
				break;
			case 25 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:171: T__67
				{
				mT__67(); 
				...
				break;
			case 26 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:177: T__68
				{
				mT__68(); 
				...
				break;
			case 27 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:183: T__69
				{
				mT__69(); 
				...
				break;
			case 28 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:189: T__70
				{
				mT__70(); 
				...
				break;
			case 29 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:195: T__71
				{
				mT__71(); 
				...
				break;
			case 30 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:201: T__72
				{
				mT__72(); 
				...
				break;
			case 31 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:207: T__73
				{
				mT__73(); 
				...
				break;
			case 32 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:213: T__74
				{
				mT__74(); 
				...
				break;
			case 33 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:219: T__75
				{
				mT__75(); 
				...
				break;
			case 34 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:225: T__76
				{
				mT__76(); 
				...
				break;
			case 35 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:231: T__77
				{
				mT__77(); 
				...
				break;
			case 36 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:237: T__78
				{
				mT__78(); 
				...
				break;
			case 37 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:243: T__79
				{
				mT__79(); 
				...
				break;
			case 38 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:249: T__80
				{
				mT__80(); 
				...
				break;
			case 39 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:255: T__81
				{
				mT__81(); 
				...
				break;
			case 40 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:261: T__82
				{
				mT__82(); 
				...
				break;
			case 41 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:267: T__83
				{
				mT__83(); 
				...
				break;
			case 42 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:273: T__84
				{
				mT__84(); 
				...
				break;
			case 43 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:279: T__85
				{
				mT__85(); 
				...
				break;
			case 44 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:285: T__86
				{
				mT__86(); 
				...
				break;
			case 45 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:291: T__87
				{
				mT__87(); 
				...
				break;
			case 46 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:297: T__88
				{
				mT__88(); 
				...
				break;
			case 47 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:303: T__89
				{
				mT__89(); 
				...
				break;
			case 48 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:309: T__90
				{
				mT__90(); 
				...
				break;
			case 49 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:315: T__91
				{
				mT__91(); 
				...
				break;
			case 50 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:321: T__92
				{
				mT__92(); 
				...
				break;
			case 51 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:327: Operation
				{
				mOperation(); 
				...
				break;
			case 52 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:337: NumberToken
				{
				mNumberToken(); 
				...
				break;
			case 53 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:349: StringToken
				{
				mStringToken(); 
				...
				break;
			case 54 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:361: HistoricalData
				{
				mHistoricalData(); 
				...
				break;
			case 55 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:376: WhiteChar
				{
				mWhiteChar(); 
				...
				break;
			case 56 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:386: Tcheat
				{
				mTcheat(); 
				...
				break;
			case 57 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:393: WS
				{
				mWS(); 
				...
				break;
			case 58 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:396: COMMENT
				{
				mCOMMENT(); 
				...
				break;
			case 59 :
				// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:1:404: LINE_COMMENT
				{
				mLINE_COMMENT(); 
	...
	static final String DFA13_minS =
		...
		"\1\0\1\60\1\0\1\154\2\0\1\60\1\0\1\uffff\1\40\1\0\2\uffff\1\144\1\0\2"+
		"\uffff\1\150\1\40\1\163\1\40\1\150\1\40\1\0\1\60\1\0\1\60\1\0\1\40\1\0"+
		"\2\uffff\1\60\1\0\1\uffff\1\0\1\157\1\160\2\uffff\3\150\1\151\1\157\1"+
	...
	static final String DFA13_maxS =
		...
		"\0\1\172\1\0\1\172\1\0\2\uffff\1\172\1\0\1\uffff\1\0\1\157\1\160\2\uffff"+
	...
	static final String DFA13_acceptS =
		...
		"\1\64\1\uffff\1\65\2\uffff\1\67\1\63\1\71\4\uffff\1\70\34\uffff\1\72\1"+
		"\73\17\uffff\1\10\54\uffff\1\1\11\uffff\1\6\4\uffff\1\13\16\uffff\1\33"+
		"\26\uffff\1\16\1\uffff\1\4\4\uffff\1\66\1\uffff\1\52\23\uffff\1\44\2\uffff"+
		"\1\51\41\uffff\1\34\1\35\35\uffff\1\26\26\uffff\1\5\2\uffff\1\17\1\20"+
		"\2\uffff\1\27\1\30\15\uffff\1\61\1\62\2\uffff\1\53\3\uffff\1\31\1\32\7"+
		"\uffff\1\56\1\57\1\60\1\uffff\1\25\2\uffff\1\36\1\37\1\uffff\1\42\1\43"+
		"\2\uffff\1\54\1\55\6\uffff\1\23\1\24\1\40\1\41\5\uffff\1\21\1\22\3\uffff"+
		"\1\47\1\50\1\45\1\46";
	static final String DFA13_specialS =
		"\1\117\1\141\2\uffff\1\172\1\u010c\1\26\1\uffff\1\u0102\2\uffff\1\37\2"+
		"\uffff\1\153\1\171\1\124\1\150\1\145\1\23\1\130\1\u0103\1\151\1\40\1\160"+
		"\3\uffff\1\167\1\u0084\4\uffff\1\u0081\1\u010a\1\146\1\uffff\1\u0088\1"+
		"\53\1\u008b\1\133\1\u0101\1\67\1\143\1\122\1\u0104\1\0\1\5\1\147\1\125"+
		"\1\66\1\74\1\u0080\1\121\1\76\1\u0086\1\173\1\12\1\155\1\31\1\41\1\50"+
		"\1\u0105\1\131\1\134\2\uffff\1\16\1\u008f\1\u010b\1\u0090\1\u00a0\1\u0089"+
		"\1\u00ca\1\55\1\u00cb\1\u008c\1\u00d2\1\115\1\u00f7\1\43\1\u008e\1\uffff"+
		"\1\144\1\u00fa\1\123\1\u00b2\1\104\1\u00b3\1\1\1\u00c5\1\6\1\u00b4\1\152"+
		"\1\u0091\1\126\1\u00e0\1\70\1\u00c7\1\75\1\u009b\1\u0082\1\u00f6\1\15"+
		"\1\u009f\1\101\1\u00cc\1\uffff\1\u00f0\1\174\1\u00de\1\13\1\u00a4\1\156"+
		"\1\u0093\1\32\1\u00f1\1\42\1\u00bf\1\51\1\u00c4\1\u0106\1\u00a5\1\132"+
		"\1\u00cf\1\135\1\u00e3\1\uffff\1\u010d\1\u00ef\1\25\1\u00f4\1\57\1\u00ea"+
		"\1\u008d\1\u00b9\1\105\1\uffff\1\120\1\u00ab\1\112\1\u00d3\1\uffff\1\2"+
		"\1\u00be\1\7\1\u00d6\1\154\1\u00b1\1\127\1\u00dd\1\71\1\u00fe\1\77\1\u00e4"+
		"\1\u0083\1\u00c1\1\uffff\1\103\1\u00a1\2\uffff\1\175\1\u00cd\1\14\1\u00ae"+
		"\1\161\1\u009d\1\33\1\u00a6\1\44\1\u009a\1\52\1\u00e9\1\u0107\1\u00ee"+
		"\1\114\1\u0095\1\136\1\u00f5\1\uffff\1\u00bd\1\uffff\1\61\1\u00c6\1\u009c"+
		"\1\u00aa\1\uffff\1\17\1\uffff\1\106\1\3\1\u00db\1\10\1\u00af\1\157\1\u00d7"+
		"\1\113\1\u00dc\1\72\1\u00a7\1\100\1\u0096\1\u0085\1\u00f9\1\uffff\1\u00e5"+
		"\3\uffff\1\176\1\u0092\1\uffff\1\u00d9\1\162\1\u00a3\1\34\1\u00da\1\45"+
		"\1\u0098\1\54\1\u00c8\1\u0108\1\u00b0\1\107\1\137\1\u00f8\1\63\1\u00ac"+
		"\1\u0100\1\u00b6\1\20\1\u00d8\1\4\1\u00e2\1\11\1\u00c0\1\163\1\u00b7\1"+
		"\110\1\73\1\u00c9\1\102\1\u00d0\1\u0087\1\u00a8\6\uffff\1\u00c2\1\164"+
		"\1\u00a2\1\35\1\u00df\1\46\1\u009e\1\56\1\u00e7\1\u0109\1\u00eb\1\116"+
		"\1\u00e8\1\64\1\u00c3\1\30\1\u0099\1\21\1\u00a9\1\140\1\u0094\1\142\1"+
		"\u00ff\1\165\1\u00ec\1\uffff\1\u00fc\1\u008a\1\u00ce\1\uffff\1\u00fd\4"+
		"\uffff\1\166\1\u00d1\1\36\1\u00ba\1\47\1\u00d4\1\60\1\u00e6\1\uffff\1"+
		"\u00ad\1\111\1\65\1\u00f2\1\uffff\1\22\1\u00d5\3\uffff\1\u00b5\7\uffff"+
		"\1\170\1\u00b8\1\24\1\u00fb\1\27\1\u00ed\1\62\1\u00bb\2\uffff\1\177\1"+
		"\u00bc\1\uffff\1\u00e1\12\uffff\1\u0097\3\uffff\1\u00f3\44\uffff}>";
		...
		public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
			...
			switch ( s ) {
					...
					case 127 : 
						...
						input.rewind();
						s = -1;
						if ( ((LA13_325 >= '0' && LA13_325 <= '9')||(LA13_325 >= 'A' && LA13_325 <= 'Z')||(LA13_325 >= 'a' && LA13_325 <= 'z')) ) {s = 36;}
