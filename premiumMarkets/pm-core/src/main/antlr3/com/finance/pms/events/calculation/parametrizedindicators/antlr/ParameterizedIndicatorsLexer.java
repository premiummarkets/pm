// $ANTLR 3.5.2 com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g 2018-09-04 19:43:13
 //lexer
...
public class ParameterizedIndicatorsLexer extends Lexer {
	...
	public final void mOperation() throws RecognitionException {
		try {
			int _type = Operation;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:287:7: ({...}? => ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:287:9: {...}? => ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
			{
			if ( !((runtimeOpAhead())) ) {
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:287:60: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
			int cnt1=0;
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mNumberToken() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:7: ( ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:9: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:9: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:11: ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:11: ( '-' )?
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:12: '-'
					{
					match('-'); 
					}
					break;
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:18: ( '0' .. '9' )+
			int cnt3=0;
			loop3:
			while (true) {
				int alt3=2;
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:30: ( '.' ( '0' .. '9' )+ )?
			int alt5=2;
			...
			switch (alt5) {
				case 1 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:31: '.' ( '0' .. '9' )+
					{
					match('.'); 
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:291:35: ( '0' .. '9' )+
					int cnt4=0;
					loop4:
					while (true) {
						int alt4=2;
	...
	public final void mStringToken() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:295:6: ( '\"' ( 'a' .. 'z' | 'A' .. 'Z' | '.' | '_' )* '\"' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:295:8: '\"' ( 'a' .. 'z' | 'A' .. 'Z' | '.' | '_' )* '\"'
			{
			match('\"'); 
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:295:12: ( 'a' .. 'z' | 'A' .. 'Z' | '.' | '_' )*
			loop6:
			while (true) {
				int alt6=2;
	...
	public final void mHistoricalData() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:4: ({...}? => ( 'open' | 'close' | 'high' | 'low' | 'volume' ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:6: {...}? => ( 'open' | 'close' | 'high' | 'low' | 'volume' )
			{
			if ( !((runtimeHistoryOpAhead())) ) {
				throw new FailedPredicateException(input, "HistoricalData", "runtimeHistoryOpAhead()");
			}
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:36: ( 'open' | 'close' | 'high' | 'low' | 'volume' )
			int alt7=5;
			switch ( input.LA(1) ) {
			case 'o':
				{
			...
			switch (alt7) {
				case 1 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:38: 'open'
					{
					match("open"); 
					...
					break;
				case 2 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:47: 'close'
					{
					match("close"); 
					...
					break;
				case 3 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:57: 'high'
					{
					match("high"); 
					...
					break;
				case 4 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:66: 'low'
					{
					match("low"); 
					...
					break;
				case 5 :
					// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:299:75: 'volume'
					{
					match("volume"); 
	...
	public final void mWhiteChar() throws RecognitionException {
		try {
			int _type = WhiteChar;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:303:7: ( ( ( ' ' )+ ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:303:9: ( ( ' ' )+ )
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:303:9: ( ( ' ' )+ )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:303:10: ( ' ' )+
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:303:10: ( ' ' )+
			int cnt8=0;
			loop8:
	...
	public final void mTcheat() throws RecognitionException {
		try {
			int _type = Tcheat;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:307:6: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+ )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:307:8: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
			{
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:307:8: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
			int cnt9=0;
			loop9:
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:312:5: ( ( '\\r' | '\\t' | '\\u000C' | '\\n' ) )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:312:7: ( '\\r' | '\\t' | '\\u000C' | '\\n' )
			{
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:315:5: ( '/*' ( . )* '*/' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:315:7: '/*' ( . )* '*/'
			{
			match("/*"); 

			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:315:12: ( . )*
			loop10:
			while (true) {
				int alt10=2;
	...
	public final void mLINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:318:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:318:7: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
			{
			match("//"); 

			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:318:12: (~ ( '\\n' | '\\r' ) )*
			loop11:
			while (true) {
				int alt11=2;
			...
			// com/finance/pms/events/calculation/parametrizedindicators/antlr/ParameterizedIndicators.g:318:26: ( '\\r' )?
			int alt12=2;
	...
	static final String DFA13_specialS =
		"\1\112\1\43\2\uffff\1\u00e6\1\u00cd\1\1\1\uffff\1\115\2\uffff\1\14\2\uffff"+
		"\1\114\1\66\1\57\1\111\1\41\1\116\1\2\1\u00cc\1\54\1\75\3\uffff\1\104"+
		"\1\u00ce\4\uffff\1\35\1\60\1\11\1\uffff\1\40\1\44\1\u00d6\1\52\1\72\1"+
		"\u00dc\1\u00cf\1\55\1\67\1\76\1\12\1\u00d1\1\u00c6\1\21\1\u00db\1\u00be"+
		"\1\u00de\1\u00e4\1\63\1\0\1\117\1\125\1\u00bb\1\u00d4\1\u00d7\2\uffff"+
		"\1\32\1\131\1\61\1\132\1\133\1\42\1\147\1\45\1\u0084\1\34\1\u0085\1\56"+
		"\1\u0090\1\uffff\1\u00dd\1\u00a2\1\u00d0\1\u00b8\1\113\1\141\1\70\1\u009d"+
		"\1\100\1\160\1\13\1\u008c\1\u00d2\1\150\1\u00c7\1\u0086\1\22\1\u0091\1"+
		"\26\1\u009f\1\u00c1\1\u00a0\1\uffff\1\153\1\u00e5\1\u0087\1\64\1\u00a8"+
		"\1\3\1\u00a9\1\120\1\163\1\126\1\u00b2\1\u00bc\1\130\1\u00d5\1\177\1\u00d8"+
		"\1\164\1\uffff\1\62\1\u009a\1\51\1\174\1\46\1\u00a3\1\u00df\1\uffff\1"+
		"\77\1\u00b7\1\30\1\134\1\uffff\1\71\1\u0080\1\101\1\137\1\15\1\u0092\1"+
		"\u00d3\1\165\1\u00c8\1\151\1\23\1\173\1\uffff\1\u00c4\1\u0088\2\uffff"+
		"\1\u00e7\1\u0094\1\65\1\u009c\1\4\1\161\1\121\1\u00b0\1\127\1\143\1\u00bd"+
		"\1\162\1\33\1\u00aa\1\u00d9\1\u008e\1\uffff\1\u0081\1\uffff\1\47\1\u00a7"+
		"\1\uffff\1\105\1\uffff\1\u00e0\1\73\1\u008d\1\102\1\140\1\16\1\u0099\1"+
		"\31\1\u00ad\1\u00c9\1\142\1\24\1\156\1\uffff\1\176\3\uffff\1\u00e8\1\u0083"+
		"\1\uffff\1\u008a\1\5\1\u00a1\1\122\1\u009e\1\145\1\u00b3\1\u00bf\1\u0098"+
		"\1\u00e1\1\u00da\1\u0095\1\50\1\u00b6\1\106\1\u008b\1\74\1\157\1\103\1"+
		"\u00ab\1\17\1\166\1\u00e2\1\u00ca\1\u00b4\1\25\1\u00b1\6\uffff\1\175\1"+
		"\6\1\152\1\123\1\u00ac\1\u00b9\1\144\1\u00c0\1\171\1\37\1\135\1\53\1\167"+
		"\1\107\1\170\1\u00c5\1\u00a4\1\u00cb\1\172\1\20\1\u00af\1\uffff\1\u0082"+
		"\1\uffff\1\u008f\4\uffff\1\7\1\u009b\1\124\1\146\1\u00ba\1\u0093\1\u00c2"+
		"\1\u00a5\1\u00e3\1\uffff\1\110\1\u00b5\3\uffff\1\154\6\uffff\1\10\1\136"+
		"\1\27\1\u0096\1\36\1\u00a6\1\u00c3\1\155\1\uffff\1\u0097\12\uffff\1\u0089"+
		"\3\uffff\1\u00ae\43\uffff}>";
