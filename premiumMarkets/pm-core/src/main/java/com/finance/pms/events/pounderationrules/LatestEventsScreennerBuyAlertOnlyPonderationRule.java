...
/**
 * Filters specific Alerts for buy
 * @author Guillaume Thoreton
 */
public class LatestEventsScreennerBuyAlertOnlyPonderationRule extends LatestEventsScreenerBuyPonderationRule {
	
	private static final long serialVersionUID = 3478291411291712753L;
	
	public LatestEventsScreennerBuyAlertOnlyPonderationRule(String portfolioName) {
		super(portfolioName);
	...
	public int compare(SymbolEvents o1, SymbolEvents o2) {
		...
		SymbolEvents se1 = o1;
		SymbolEvents se2 = o2;
		PonderationRule p1 = new LatestEventsScreennerBuyAlertOnlyPonderationRule(portfolioName);
		PonderationRule p2 = new LatestEventsScreennerBuyAlertOnlyPonderationRule(portfolioName);
