...
public class StockListNSEIndiaFormater extends LineFormater {
	
	StockCategories stockCategorie;
	MarketQuotationProviders marketQuotationsProviders;
	
	public StockListNSEIndiaFormater(String url, StockCategories stockCategorie,MarketQuotationProviders marketQuotationsProviders) {
		super(new MyUrl(url));
