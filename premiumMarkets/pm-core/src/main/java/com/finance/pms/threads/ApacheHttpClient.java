 ...
 */
public class ApacheHttpClient implements SourceClient, MyHttpClient<HttpUriRequest, CloseableHttpResponse> {
...
//	}
	...
	@Override
	public CloseableHttpResponse doCall(HttpUriRequest method) throws IOException, ClientProtocolException {
