...
public abstract class OneEventScreenerPonderationRule extends LatestEventsPonderationRule {
	
	private static final long serialVersionUID = -8895763294605632654L;
	protected String portfolioName;

	public OneEventScreenerPonderationRule(String portfolioName) {
		super(
	...
	public int compare(SymbolEvents o1, SymbolEvents o2) {
		SymbolEvents se1 = o1;
		SymbolEvents se2 = o2;
		PonderationRule p1 = getPonderationRuleImpl();
		PonderationRule p2 = getPonderationRuleImpl();
	...
	@Override
	public abstract Signal initSignal(SymbolEvents symbolEvents);
