...
public class VariancePonderationRule extends DefaultPonderationRule {

	private static final long serialVersionUID = -1988941450030243454L;

	private VariancePonderationRule() {
		super(
	...
	public int compare(SymbolEvents o1, SymbolEvents o2) {
		SymbolEvents se1 = o1;
		SymbolEvents se2 = o2;
		PonderationRule p1 = new VariancePonderationRule();
		PonderationRule p2 = new VariancePonderationRule();
