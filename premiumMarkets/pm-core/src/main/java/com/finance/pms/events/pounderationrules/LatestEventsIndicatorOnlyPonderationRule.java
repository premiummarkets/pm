...
public class LatestEventsIndicatorOnlyPonderationRule extends LatestEventsPonderationRule {

	private static final long serialVersionUID = -1852887356861603194L;

	public LatestEventsIndicatorOnlyPonderationRule() {
		super(
	...
	public int compare(SymbolEvents o1, SymbolEvents o2) {
		...
		SymbolEvents se1 = o1;
		SymbolEvents se2 = o2;
		LatestEventsIndicatorOnlyPonderationRule p1 = new LatestEventsIndicatorOnlyPonderationRule();
		LatestEventsIndicatorOnlyPonderationRule p2 = new LatestEventsIndicatorOnlyPonderationRule();
	...
	public Signal initSignal(SymbolEvents symbolEvents) {
		return new LatestEventsSignal(false, true);
	}
