...
public class ParameterizedEventKey extends EventKey {
	...
	public ParameterizedEventKey(Date date, EventInfo eventdef, EventType eventType) {
		super();
		this.date = date;
	...
	public ParameterizedEventKey(Date date, String eventInfoReference, String eventType) throws NoSuchFieldException {
		super();
		this.date = date;
