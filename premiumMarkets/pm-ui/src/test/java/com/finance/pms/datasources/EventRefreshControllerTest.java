...
public class EventRefreshControllerTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		MainPMScmd.getPrefs().put("gui.crit.date", new SimpleDateFormat("yyyy/MM/dd").format(startAnalyseDate));
		MainPMScmd.getPrefs().put("quotes.lastlistfetch","1970/01/01");
		MainPMScmd.getPrefs().put("quotes.lastfetch", "1970/01/01");
		MainPMScmd.getPrefs().put("quotes.lastanalyse", "1970/01/01");
