...
java -splash:"%CD%\icons\squeakyPig.png" -Xmx512M -XX:PermSize=64M -XX:MaxPermSize=128M -Djava.library.path="%CD%\lib" -Dinstalldir="%CD%" -jar "%CD%\pm.jar" "%CD%\db.properties"
